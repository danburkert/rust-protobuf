...
pub trait ProtobufType {
    ...
    fn write_with_cached_size<W>(field_number: u32, value: &Self::Value, os: &mut W) -> ProtobufResult<()> where W: Write;
}
...
impl ProtobufType for ProtobufTypeFloat {
    ...
    fn write_with_cached_size<W>(field_number: u32, value: &f32, os: &mut W) -> ProtobufResult<()> where W: Write {
...
impl ProtobufType for ProtobufTypeDouble {
    ...
    fn write_with_cached_size<W>(field_number: u32, value: &f64, os: &mut W) -> ProtobufResult<()> where W: Write {
...
impl ProtobufType for ProtobufTypeInt32 {
    ...
    fn write_with_cached_size<W>(field_number: u32, value: &i32, os: &mut W) -> ProtobufResult<()> where W: Write {
...
impl ProtobufType for ProtobufTypeInt64 {
    ...
    fn write_with_cached_size<W>(field_number: u32, value: &i64, os: &mut W) -> ProtobufResult<()> where W: Write {
...
impl ProtobufType for ProtobufTypeUint32 {
    ...
    fn write_with_cached_size<W>(field_number: u32, value: &u32, os: &mut W) -> ProtobufResult<()> where W: Write {
...
impl ProtobufType for ProtobufTypeUint64 {
    ...
    fn write_with_cached_size<W>(field_number: u32, value: &u64, os: &mut W) -> ProtobufResult<()> where W: Write {
...
impl ProtobufType for ProtobufTypeBool {
    ...
    fn write_with_cached_size<W>(field_number: u32, value: &bool, os: &mut W) -> ProtobufResult<()> where W: Write {
...
impl ProtobufType for ProtobufTypeString {
    ...
    fn write_with_cached_size<W>(field_number: u32, value: &String, os: &mut W) -> ProtobufResult<()> where W: Write {
...
impl ProtobufType for ProtobufTypeBytes {
    ...
    fn write_with_cached_size<W>(field_number: u32, value: &Vec<u8>, os: &mut W) -> ProtobufResult<()> where W: Write {
...
impl<E : ProtobufEnum + ProtobufValue> ProtobufType for ProtobufTypeEnum<E> {
    ...
    fn write_with_cached_size<W>(field_number: u32, value: &E, os: &mut W) -> ProtobufResult<()> where W: Write {
